...
from convlab2.nlu.jointBERT.dataloader_xlmr import Dataloader
from convlab2.nlu.jointBERT.jointXLMR import JointXLMR
...
if __name__ == '__main__':
    ...
    model = JointXLMR(config['model'], DEVICE, dataloader.tag_dim, dataloader.intent_dim, dataloader.intent_weight)
    model.to(DEVICE)
